...
export default function App() {
  ...
  const SITE_CLOSED = true; // set false when you want chatbot live again
      ...
      <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
        <div className="max-w-xl w-full bg-white border border-slate-200 rounded-2xl shadow-lg p-8 text-center">
          ...
          <p className="text-slate-600 mb-4 leading-relaxed">
            The Vidhan Bhavan Adhiveshan has concluded.  
            This chatbot service is currently unavailable.
          </p>

          <p className="text-slate-700 font-medium mb-2">
            We provide <strong>Chatbot & AI Solutions</strong>
          </p>
          ...
          <div className="space-y-2 text-slate-800">
            <p>
              📧 Email:{" "}
              <a
                href="mailto:aditya3daharwal@gmail.com"
                className="text-indigo-600 hover:underline"
              >
                aditya3daharwal@gmail.com
              </a>
            </p>
            <p>
              📧 Email:{" "}
              <a
                href="mailto:adityagjadhav46@gamil.com,"
                className="text-indigo-600 hover:underline"
              >
                adityagjadhav46@gamil.com,
              </a>
            </p>
            <p>
              📞 Phone:{" "}
              <a
                href="tel:+919130678858"
                className="text-indigo-600 hover:underline"
              >
                +91 9130678858
              </a>
